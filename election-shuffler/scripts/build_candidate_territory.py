...
def main() -> None:
    ...
    pinto = ward_decay(geojson, wards, "2", decay_km=0.75)
    for pid, score in pinto.items():
        output[("14_brooke_pinto", pid)] = {
            "model_key": "14_brooke_pinto",
            "candidate": "Brooke Pinto",
            "pid": pid,
            "territory_score": score,
            "territory_type": "ward_edge_decay",
            "source": "2024 Ward 2 council district; 0.75 km outside-edge decay",
        }
